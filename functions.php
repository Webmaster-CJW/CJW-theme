...
function cjw_brummen_scripts() {
	wp_enqueue_style( 'cjw-theme-style', get_stylesheet_uri(), array(), CJW_BRUMMEN_VERSION );
	wp_style_add_data( 'cjw-theme-style', 'rtl', 'replace' );

	wp_enqueue_script( 'cjw-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), CJW_BRUMMEN_VERSION, true );
